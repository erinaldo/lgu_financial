...
Public Class frmChangePassword
    ...
    Private Sub cmdSaveButton_Click(sender As Object, e As EventArgs) Handles cmdSaveButton.Click
        ...
        ElseIf txtNewPassword.Text <> txtVerifyPassword.Text Then
            ...
            Exit Sub
        End If
        com.CommandText = "update tblaccounts set password='" & EncryptTripleDES(UCase(txtFullname.Text) + txtVerifyPassword.Text) & "' where accountid='" & userid.Text & "'" : com.ExecuteNonQuery()
