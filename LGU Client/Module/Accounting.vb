...
Module Accounting
    Public Function CancelVoucher(ByVal voucherid As String, ByVal pid As String, ByVal remarks As String)
        Try
            ...
            da = New MySqlDataAdapter("select *, (select date_format(concat(date_format(current_date,'%Y'),'-',monthcode,'-1'),'%M') from tblbudgetcomposition where periodcode=a.periodcode and itemcode=a.itemcode and officeid=a.officeid) as monthname " _
