Module ConvertNumberToWords
    Public Function ConvertKwartaToEnglish(ByVal MyNumber As Double) As String
        Dim Temp As String
        ...
        If Dollars & Cents <> "" Then
            ConvertKwartaToEnglish = Dollars & " Pesos " & If(Cents = "", "", "and " & Cents)
        End If
    End Function
    ...
    Public Function ConvertCurrencyToEnglish(ByVal MyNumber As Double) As String
        ...
        Select Case Cents
            Case "" : Cents = ""
            Case "One" : Cents = "One"
            Case Else : Cents = Cents
        End Select

        If Dollars <> "" And Cents <> "" Then
            ConvertCurrencyToEnglish = Dollars & " and " & Cents & If(Cents = "One", " cent.", " cents.")

        ElseIf Dollars = "" And Cents <> "" Then
            ConvertCurrencyToEnglish = Cents & If(Cents = "One", " cent", " cents") & " only."

        ElseIf Dollars <> "" And Cents = "" Then
            ConvertCurrencyToEnglish = Dollars & If(Right(Dollars, 1) = " ", "pesos only.", " pesos")
