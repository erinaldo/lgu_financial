...
Module Libraries
    ...
    Public Sub LoadDefaultDropdown(ByVal formname As String, ByVal controlname As SearchLookUpEdit)
        ...
        da = New MySqlDataAdapter("select * from tbldefaultdropdown where formname='" & formname & "' and controlname='" & controlname.Name & "' and userid='" & globaluserid & "'", conn)
        da.Fill(st, 0)
        For v = 0 To st.Tables(0).Rows.Count - 1
            With (st.Tables(0))
                controlname.EditValue = .Rows(v)("defaultcode").ToString()
            End With
        Next
    End Sub

    Public Sub SaveDefaultDropdown(ByVal formname As String, ByVal controlname As SearchLookUpEdit)
        com.CommandText = "DELETE FROM tbldefaultdropdown where formname='" & formname & "' and controlname='" & controlname.Name & "' and userid='" & globaluserid & "' " : com.ExecuteNonQuery()
        com.CommandText = "insert into tbldefaultdropdown set formname='" & formname & "', controlname='" & controlname.Name & "',userid='" & globaluserid & "', defaultcode='" & controlname.EditValue & "' " : com.ExecuteNonQuery()
    End Sub


    Public Function DXLoadToComboBoxQuery(ByVal fld As String, ByVal query As String, ByVal combo As DevExpress.XtraEditors.ComboBoxEdit)
    ...
    Public Function DXLoadToComboBoxQuery(ByVal fld As String, ByVal fquery As String, ByVal tblandQuery As String, ByVal combo As DevExpress.XtraEditors.ComboBoxEdit)
        ...
        Return Coll
    End Function
    Public Function LoadXgrid(ByVal qry As String, ByVal tbl As String, ByVal Em As DevExpress.XtraGrid.GridControl, ByVal xgrid As DevExpress.XtraGrid.Views.Grid.GridView, ByVal frm As Form)
        Try
    ...
    Public Function XgridColumnDropChanged(ByVal xgrid As DevExpress.XtraGrid.Views.Grid.GridView, ByVal frm As String)
    ...
    Public Function XgridColumnWidthChanged(ByVal xgrid As DevExpress.XtraGrid.Views.Grid.GridView, ByVal frm As String)
        com.CommandText = "delete from tblcolumnindex where form='" & frm & "' and gridview='" & xgrid.Name & "'" : com.ExecuteNonQuery()
        For I = 0 To xgrid.Columns.Count - 1
            If xgrid.Columns(I).VisibleIndex >= 0 Then
                com.CommandText = "insert into tblcolumnindex set form='" & frm & "', gridview='" & xgrid.Name & "', columnname='" & rchar(xgrid.Columns(I).FieldName) & "', columnwidth='" & xgrid.Columns(I).Width & "', colindex='" & xgrid.Columns(I).VisibleIndex & "'" : com.ExecuteNonQuery()
    ...
    Public Function DXDeleteRow(ByVal col As String, ByVal fld As String, ByVal tbl As String, ByVal Xgrid As DevExpress.XtraGrid.Views.Grid.GridView, ByVal myform As DevExpress.XtraEditors.XtraForm)
        ...
        Return 0
    End Function
    Public Function DXRemoveRow(ByVal col As String, ByVal fld As String, ByVal tbl As String, ByVal Xgrid As DevExpress.XtraGrid.Views.Grid.GridView, ByVal myform As DevExpress.XtraEditors.XtraForm)
        Try
            Dim Row As DataRow : Dim Rows() As DataRow : Dim I As Integer : Dim todelete As String = ""
            ReDim Rows(Xgrid.SelectedRowsCount - 1)
            For I = 0 To Xgrid.SelectedRowsCount - 1
    ...
    Public Sub DXgridColumnIndexing(ByVal filter As String, ByVal xgrid As DevExpress.XtraGrid.Views.Grid.GridView)
        com.CommandText = "select * from tblcolumnindex where form='" & filter & "' and gridview='" & xgrid.Name & "' order by colindex asc" : rst = com.ExecuteReader
        While rst.Read
            For Each col In xgrid.Columns
                If col.Fieldname = rst("columnname").ToString Then
                    xgrid.Columns(rst("columnname").ToString).VisibleIndex = rst("colindex")
                    If Val(rst("columnwidth")) > 0 Then
                        xgrid.Columns(rst("columnname").ToString).Width = rst("columnwidth")
                    End If
                End If
            Next
        End While
