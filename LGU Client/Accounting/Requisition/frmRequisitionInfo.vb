...
Public Class frmRequisitionInfo
    ...
    Private Sub frmRequisitionInfo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If txtStatus.Text = "ON HOLD" Then
            frmHoldMessage.txtMessage.Text = qrysingledata("msgby", "concat(confirmby,' : ', remarks) as msgby", "tblapprovalhistory as a where mainreference='" & pid.Text & "' and status='Hold' order by dateconfirm desc limit 1")
